...
const [lunchType, setLunchType] = useState<'lunch-start' | 'lunch-end' | null>(null);
          ...
          <section className="lunch-section">
            <div className="section-header">
              ...
              <div className="section-actions">
                <button
  className="btn primary"
  onClick={() => { setLunchType('lunch-start'); setShowLunchCam(true); }}
>
  Start Lunch
</button>
...
<button
  className="btn secondary"
  onClick={() => { setLunchType('lunch-end'); setShowLunchCam(true); }}
>
  End Lunch
</button>
              </div>
...
{showLunchCam && lunchType && (
  <div className="modal-overlay">
    <div className="modal camera-modal">
      <div className="modal-header">
        <h3>{lunchType === 'lunch-start' ? 'Start Lunch' : 'End Lunch'} – {employeeName}</h3>
        <button className="close-btn" onClick={() => { setShowLunchCam(false); setLunchType(null); }}>✕</button>
      </div>
      <div className="camera-content">
        <LunchCam
          employeeId={employeeId}
          ...
          onCancel={() => { setShowLunchCam(false); setLunchType(null); }}
        />
      </div>
    </div>
  </div>
